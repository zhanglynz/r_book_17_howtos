...
- **Step 6:** Version control---link to a repo in Github
    ...
    - set up connection by clicking  `Git` button; then clicking on the “two purple boxes and a white square” in the Git pane .... (Reference: section 17.5.3 on https://happygitwithr.com/existing-github-last.html)
    - commit and push
